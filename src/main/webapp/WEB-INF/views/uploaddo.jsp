...
<body>
    ...
    <br><br><br><br><br><br>
        ...
        <div class="container mt-3" style="width: 320px; padding-top: 30px;">
        		<h3 class="stagger-item" style="text-align:center;">업로드 성공 </h3>
                <h3 class="stagger-item" style="text-align:center;">Congratulation!!</h3>
                <button type="submit" class="pic btn btn-dark stagger-item" id="do" onclick="location.href='/myart'"
                style="margin-top: 15px; width: 300px;">내 전시 보러 가기</button>
                <br>

            <button type="submit" class="pic btn btn-dark stagger-item" id="jo" onclick="location.href='/exhibit'"
                style="margin-top: 15px; width: 300px;">파일 업로드 하러 가기</button>
